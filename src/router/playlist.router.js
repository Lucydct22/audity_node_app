...
api
  ...
  .put(
    '/playlist-add-track/playlists/:playlistId/tracks/:trackId',
    [md_auth.ensureAuth],
    controller.putTrackToPlaylist
  )
  .delete(
    '/delete-track-from-playlist/playlists/:playlistId/tracks/:trackId',
    [md_auth.ensureAuth],
  ...
  .put(
    '/playlist-image/:playlistId',
    [md_auth.ensureAuth, md_auth.ensureAdminAuth],
    controller.updatePlaylistImage
  )
  .put(
    '/playlist-admin/:playlistId',
    [md_auth.ensureAuth, md_auth.ensureAdminAuth],
    controller.updatePlaylistAdmin
  )
  .put(
    '/update-public-accessible/:playlistId',
    [md_auth.ensureAuth, md_auth.ensureAdminAuth],
    controller.updatePublicAccessible
  )
